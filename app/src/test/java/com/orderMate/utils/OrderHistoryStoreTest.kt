 ...
 * codebase's existing convention (see OrderListRedesignFragmentTest, WidgetManagerTest), these
 * tests mirror the pure merge/eviction logic locally with a lightweight stand-in.
 */
