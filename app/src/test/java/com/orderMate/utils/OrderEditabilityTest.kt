 ...
 * tests avoid constructing directly (see ItemNoteDialogTest/OrderCardRedesignAdapterTest for
 * the established convention) - so this mirrors just the state string the real function
 * resolves from `order.paymentState?.name ?: order.state`.
 */
