...
class FloatingWidgetService : Service(), IOrderItemClickListener {
    ...
    private fun setTheWindowParamsForPermanentOverlay(): WindowManager.LayoutParams {
        ...
        // Clover register left panel width: 24.5%
        val drawerWidth = (screenWidth * 0.245).toInt()
        ...
        // Bottom offset: 15.5% (flush with Save/Pay footer)
        val bottomOffset = (screenHeight * 0.155).toInt()
