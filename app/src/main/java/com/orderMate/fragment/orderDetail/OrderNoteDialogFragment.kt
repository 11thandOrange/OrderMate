...
class OrderNoteDialogFragment : DialogFragment() {
    ...
    private fun addCustomerSection(widget: WidgetConfig) {
        ...
        val nameView = sectionView.findViewById<TextView>(R.id.customerName)
        val actionView = sectionView.findViewById<TextView>(R.id.customerAction)
        customerNameView = nameView
        customerActionView = actionView
        renderCustomer()
