...
public final class ItemColorBinding implements ViewBinding {
  ...
  private ItemColorBinding(@NonNull FrameLayout rootView, @NonNull FrameLayout colorView) {
  ...
  public static ItemColorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.colorView;
      FrameLayout colorView = ViewBindings.findChildViewById(rootView, id);
      if (colorView == null) {
        break missingId;
      }

      return new ItemColorBinding((FrameLayout) rootView, colorView);
    }
