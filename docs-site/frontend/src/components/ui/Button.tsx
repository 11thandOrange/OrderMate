...
const variantStyles: Record<ButtonVariant, string> = {
  primary: 'bg-brand hover:bg-brand-hover text-white shadow-button hover:shadow-button-hover',
  secondary: 'bg-surface hover:bg-surface-hover text-white border border-surface-border hover:border-surface-border-hover',
  ghost: 'hover:bg-surface text-gray-400 hover:text-white',
  outline: 'border border-surface-border-hover hover:bg-surface text-white',
