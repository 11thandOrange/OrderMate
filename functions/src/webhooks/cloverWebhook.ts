 ...
 */
async function handleInstall(merchantId: string, payload: any): Promise<void> {
 ...
 */
async function handleUninstall(merchantId: string, payload: any): Promise<void> {
 ...
 */
async function handleSubscriptionChange(merchantId: string, payload: any): Promise<void> {
